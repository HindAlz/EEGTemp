...
def losoModel_one_subject_all_configs(X_data_list, Y_data_list, X_test_data, Y_test_data, subject_idx, num_classes, sfreq=200, avg=False):
...
results = "results_noTCN_elu_AvgTest.pkl"
